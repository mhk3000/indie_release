...
//
  ...
  #define Y_DIR_PIN           20 //Board B5 Pin35, faulty changed to Pin 18
...
// Temperature Sensors
//
  #define TEMP_0_PIN          11  // ANALOG NUMBERING. Mahersoft Indie-DT v1.4. Extruder thermistor #1 analog pin
  #define TEMP_1_PIN          9   // ANALOG NUMBERING. Mahersoft Indie-DT v1.4. Chamber thermistor pin
...
#define HEATER_0_PIN     29   //RAMPS_D10_PIN. Extruder hotend#0
...
//
  ...
  #else
    #define LCD_PINS_RS     54
    #define LCD_PINS_ENABLE 55
    #define LCD_PINS_D4     56
    #define LCD_PINS_D5     57
    #define LCD_PINS_D6     58
